...
/**
 * 类ObjectEntityDTO.java的实现描述：
 * 
 * @author Mike 2017年4月14日 下午1:42:04 { "id" //实体id "code" //实体编码 "name" //实体名称 "displayName" //显示名称 "parentName"//父实体名称
...
public class ObjectEntityDTO implements Serializable {
    ...
    private static final long         serialVersionUID = 9114898874299649294L;
    ...
    private List<ObjectEntityAttrDTO> attributes;
