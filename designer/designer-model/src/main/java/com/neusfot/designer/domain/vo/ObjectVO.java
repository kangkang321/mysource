...
/**
 * 类ObjectVO.java的实现描述：用于接收前端的修改对象请求，传递的Json对应的实体
 * 
 * @author Mike 2017年4月13日 下午6:27:26 { "id" //对象id "code" //对象编码 "name" //对象名称 "displayName" //显示名称 "isResource"//是否资源
...
public class ObjectVO implements Serializable {
    ...
    private static final long    serialVersionUID = -785800023569081397L;
    ...
    private List<ObjectEntityVO> entitys;
}
